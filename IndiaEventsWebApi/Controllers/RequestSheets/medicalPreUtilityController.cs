                    ...
                    foreach (var name in DeviationNames)
                    {
                        ...
                        if (bs != "")
                        {
                            try
                            {
                                ...
                                newRow7.Cells.Add(new Cell { ColumnId = SheetHelper.GetColumnIdByName(sheet7, "Finance Head"), Value = /*"sybil.oommen@menariniapac.com"*/formDataList.MedicalUtilityData.Sales_Head });
