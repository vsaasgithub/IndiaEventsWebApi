            ...
            if (targetRow != null)
            {
                ...
                List<EventSettlementPayload> eventRequestBrandsList = sheetData
                    ...
                    .Select(row => new EventSettlementPayload
                    {
                        ...
                        EventSettlementMarketingHeadApproval = row.TryGetValue("EventSettlement-Marketing Head Approval", out var EventSettlementMarketingHeadApproval) ? EventSettlementMarketingHeadApproval?.ToString() : null,
